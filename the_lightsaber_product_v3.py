...
lightsaber_small = lightsaber_img.resize((184, 184)) 
...
lightsaber_flipped_small = lightsaber_flipped_img.resize((184, 184)) 
fig3, axes3 = plt.subplots(1, 2)
axes3[0].imshow(lightsaber_flipped_img)
axes3[1].imshow(lightsaber_flipped_small)
fig3.show()

republic_img.paste(lightsaber_small, (84, 184), mask=lightsaber_small) 
