...
lightsaber_small = lightsaber_img.resize((150, 150)) 
...
lightsaber_flipped_small = lightsaber_flipped_img.resize((150, 150)) 
fig3, axes3 = plt.subplots(1, 2)
axes3[0].imshow(lightsaber_flipped_img)
axes3[1].imshow(lightsaber_flipped_small)
fig3.show()

republic_img.paste(lightsaber_flipped_small, (40, 75), mask=lightsaber_flipped_small)
republic_img.paste(lightsaber_small, (40, 75), mask=lightsaber_small)  
